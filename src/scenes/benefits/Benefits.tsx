    ...
    >
      ...
      >
        ...
        <motion.div 
          ...
          <p className="my-5 text-sm">We provide world class fitness equipment, trainers and classes to get you to your ultimate fitness goals with easy. We provide true care into each and every member.</p>
        </motion.div>
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
          {/* Graphic */}
          <img src={BenefitsPageGraphic} className="mx-auto"/>
