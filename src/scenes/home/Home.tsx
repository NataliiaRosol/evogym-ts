    ...
    >
      ...
      <div className="z-10 mt-32 md:basis-3/5">
        ...
        >
          ...
          <AnchorLink className='text-sm font-bold text-primary-500 underline hover:text-yellow-500' onClick={()=> setSelectedPage(SelectedPage.ContactUs)} href={`#${SelectedPage.ContactUs}`}>
      ...
      isAboveMediumScreens && (
        <div className="h-[150px] w-full bg-primary-100 py-10">
          <div className="mx-auto w-5/6">
            <div className="flex items-center justify-between gap-8 self-center">
